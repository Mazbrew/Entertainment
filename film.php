...
<html>
    ...
    <body>
        ...
        <?php
            echo "<table><thead><tr><th>Film_id</th><th>Release_Year</th><th>Language</th><th>Rental_Duration</th><th>Rental_Rate</th><th>Length</th><th>Replacement_Cost</th><th>Rating</th><th>Special_Feautures</th><th>Last_Update</th></thead><tbody>"; 
                    ...
                    if(isset($_POST['insert'])){
                        ...
                        $result= mysqli_query($conn,$query);
                            ...
                            if(mysqli_num_rows($result)==0){
                                ...
                                $rentaldurationr= $_POST['rentalduration'];
                    ...
                    if(isset($_POST['update'])){
                        ...
                        $result= mysqli_query($conn,$query);
                            ...
                            if(mysqli_num_rows($result)==0){
                                ...
                                $specialfeatures= $_POST['specialfeatures'];
                                $lastupdate= $_POST['lastupdate'];
                                $update = "UPDATE film SET filmid='$filmid', releaseyear='$releaseyear', languageid='$languageid', rentalduration='$rentalduration',rentalrate='$rentalrate', length='$length', replacementcost='$replacementcost', rating='$rating', specialfeatures='$specialfeatures', lastupdate='$lastupdate' WHERE film_id=$flimid;";
